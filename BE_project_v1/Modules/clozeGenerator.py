...
def predictWords(wordsDf, df):
    ...
    predictorPickleName = 'C:/Users/Parth/Downloads/Question-Generation-master/Question-Generation-master/data/pickles/nb-predictor.pkl'
...
glove_file = 'C:/Users/Parth/Downloads/Question-Generation-master/Question-Generation-master/data/embeddings/glove.6B.300d.txt'
tmp_file = 'C:/Users/Parth/Downloads/Question-Generation-master/Question-Generation-master/data/embeddings/word2vec-glove.6B.300d.txt'

from gensim.scripts.glove2word2vec import glove2word2vec
#glove2word2vec(glove_file, tmp_file)
#KeyedVectors.load_word2vec_format(tmp_file).save('vectors.kv')
model = KeyedVectors.load('D:\\BE_Project\\BE_project_v1\\Modules\\vectors.kv',mmap='r')
